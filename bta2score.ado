...
_column(2) "{hline 40}"
		forvalues x=1/`=scalar(num)'{
			...
			di in green _column(2) substr("`: word `x' of `: colnames devcoef''",1,10)+"~"+substr("`: word `x' of `: colnames devcoef''",length("`: word `x' of `: colnames devcoef''")-9,10) in yellow _column(30) roundcoef[1,`x']
			}
			else{
				di in green _column(2) "`: word `x' of `: colnames devcoef''"  in yellow _column(30) roundcoef[1,`x']
			}
		}
