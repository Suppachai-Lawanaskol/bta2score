...
{phang}{cmd:bta2score} {cmd:,} [{opt name:(string)} {opt dec:imal(numlist)} {opt tab:ulation} {opt keep:cons} {opt replace:} {opt cstat:} {opt dstat:} {opt aic:} {opt bic:} {opt gof:} {opt rsquare:}]
